...
RSpec.describe "Search Request", type: :request do
  ...
  describe "PATCH /cell" do
    it "takes a proper json payload and returns a proper json payload" do
      ...
      cell_params = { plant_name: "Green Leaf", location_id: "A1", image: "google.com", watering:"Frequent", status: 1, plant_id: 1 }
    ...
    it "removes the plant from the cell and sets the status to empty" do
      cell = Cell.create!(location_id: "A1", status: 1, plant_id: 1, image: "image_url", watering:"Average", plant_name: "Pretty Flower")
